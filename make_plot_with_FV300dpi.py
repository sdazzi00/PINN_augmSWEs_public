...
if __name__ == "__main__":
    ...
    csv_filenames = [sol_dir +"dambreak100_python_fv_sol_1.00000.txt" , sol_dir +"dambreak1000_python_fv_sol_1.00000.txt"]
    csv_labels = ["FV_100", "FV_1000"]
    ...
    f.savefig(test_name + "_FV_for_paper.png")
