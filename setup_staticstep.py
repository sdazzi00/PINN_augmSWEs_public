import yaml, os
from swe_utils.riemann_step_problems import RiemannProblemStep
...
test_name = "staticstep"      # name of the test
model_name = "run_staticstep"    # name of the script with the solver
...
# instantiate problem
prb = RiemannProblemStep("RS0")                                              # with predefined values (RP0-RP8)
#prb = RiemannProblem(dim_vals=[1.,0.,0.1,0.],L=12.,xdisc=0.,tmax=0.5)    # alternatively: with custom values
prb.print_recap()
