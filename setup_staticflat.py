...
test_name = "staticflat"      # name of the test
model_name = "run_staticflat"    # name of the script with the solver
...
# instantiate problem 
prb = RiemannProblem("RP0")                                              # with predefined values (RP0-RP8)
